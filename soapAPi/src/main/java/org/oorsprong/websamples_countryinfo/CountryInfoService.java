...
/**
 * This DataFlex Web Service opens up country information2 letter ISO codes are used for Country
 *             code. There are functions to retrieve the used Currency, Language, Capital City, Continent and Telephone
 *             code.
 *         
 *
 * This class was generated by Apache CXF 3.3.2
 * 2023-11-15T12:12:53.371+05:30
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "CountryInfoService",
                  wsdlLocation = "file:/C:/Users/Gnanesh/Myworkspace/soapAPi/soapAPi/src/main/resources/countries.wsdl",
...
public class CountryInfoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Gnanesh/Myworkspace/soapAPi/soapAPi/src/main/resources/countries.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountryInfoService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Gnanesh/Myworkspace/soapAPi/soapAPi/src/main/resources/countries.wsdl");
        }
        WSDL_LOCATION = url;
    }
